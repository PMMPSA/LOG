	...
	public function onCommand(CommandSender $sender, Command $command, $label, array $args){
		switch($command->getName()){
			case "helps":
			   ...
			   return true;
			case "luat":
			   $sender->sendMessage("§r§a-=§e|§c♦§e| §dQuy Định - Luật Chơi - §bL§aO§6G§e |§c♦§e|§a=-");
			...
			case "lag":
			  ...
			  // $sender->sendMessage("§eCách 3:§b ");
			   ...
			   return true;
			case "info":
			   $sender->sendMessage("§r§a-=§e|§c♦§e| §dGiới Thiệu Thông Tin - §bL§aO§6G§e |§c♦§e|§a=-");
			   $sender->sendMessage("§7∘ §bChào mừng đến với server §bL§aO§6G");
			   $sender->sendMessage("§7∘ §aMinecraft là game sáng tạo trong thế giới ảo, xây dựng trở thành vua của thế giới");
			   $sender->sendMessage("§7∘ §bChắc hẳn ở Việt Nam rất nhiều máy chủ hay mạnh và tối ưu hơn §bL§aO§6G");
			   $sender->sendMessage("§7∘ §a§bL§aO§6G thành lập ngày §b22/6/2017 §avà cũng là ngày mở cửa chính thức");
			   $sender->sendMessage("§7∘ §a§bL§aO§6G cũng là một máy chủ mới nhưng nhiều kinh nghiệm");
			   $sender->sendMessage("§7∘ §a§bL§aO§6G có các chế độ chơi đa dạng đáp ứng nhu cầu của các bạn");
			   ...
			   $sender->sendMessage("§7∘ §bMột phần nhỏ các chế độ chơi của §bL§aO§6G");
			   $sender->sendMessage("§7∘ §a§bL§aO§6G cần sự ủng hộ của các bạn, đó là động lực giúp §bL§aO§6G phát triển hơn");
